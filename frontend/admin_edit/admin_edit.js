  ...
  if (user) {
    try {
      ...
      for (titleIndex in userObject.lesson) {
        ...
        document
          .getElementsByClassName('title-group')
          [titleIndex].getElementsByClassName('title')[0].value =
          userObject.lesson[titleIndex].name;
        ...
        for (subjectIndex in subjectObject) {
          ...
          formtitle
            .getElementsByClassName('subject-group')
            [subjectIndex].getElementsByClassName('subject')[0].value =
            subjectObject[subjectIndex].name;
          ...
          for (topicIndex in topicObject) {
            ...
            formSubject
              .getElementsByClassName('topic-group')
              [topicIndex].getElementsByClassName('topic')[0].value = topicObject[topicIndex].name;
            formSubject
              .getElementsByClassName('topic-group')
              [topicIndex].getElementsByClassName('topic-link')[0].value =
              topicObject[topicIndex].link;
          }
        }
      }
      ...
      $('#lesson-form').append(
        '<button  type="submit" id="button-save-lesson" class="btn btn-primary float-right mt-2">Save</button> '
      );
...
function saveData() {
  ...
  try {
    for (i = 0; i < title.length; i++) {
      ...
      var checkInvi = title[i]
        .getElementsByClassName('lesson-title-hide')[0]
...
function preview() {
  var win = window.open('/login/lesson/' + userObject._id, '_blank');
  //win.focus();
