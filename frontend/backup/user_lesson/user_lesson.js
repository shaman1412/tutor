...
$(document).ready(function(){
    ...
    xhr.open("GET","http://127.0.0.1:5000/user/getUserById/5d163cf6b0f3a91548ae4e4a" ,true);
...
function openInNewTab(link) {
    ...
    var query= window.btoa('Hello, world');
    //var decodedData = window.atob(encodedData)
    var win = window.open("web3/?link=" + lnk, '_blank');
    win.focus();
}
