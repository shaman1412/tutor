      ...
      for (titleIndex in userObject.lesson) {
        ...
        for (subjectIndex in subjectObject) {
          ...
          for (topicIndex in topicObject) {
            ...
            cloneTopic.getElementsByClassName('card-title')[0].innerHTML =
              topicObject[topicIndex].name;
